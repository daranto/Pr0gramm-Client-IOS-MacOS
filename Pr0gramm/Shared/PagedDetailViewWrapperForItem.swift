...
struct PagedDetailViewWrapperForItem: View {
    ...
    init(item: Item, playerManager: VideoPlayerManager, targetCommentID: Int? = nil, isPresentedInSheet: Bool = false) {
    ...
    var body: some View {
        PagedDetailView(
            ...
            isPresentedInSheet: isPresentedInSheet // Weitergeben
        )
    }
}
